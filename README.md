# tweaksLauncher
this is the first project i make outside of schools it is based on java and linux only i expect to learn a lot from it and if you see anything i should learn just tell me! im making this before i make the app so you probably wont see a lot but i will write when its ready:)

# WHY?
well i dont want to specify my age but im young, i want to get to some place that will require expirience and i belive that if i start early then i will get a lead
